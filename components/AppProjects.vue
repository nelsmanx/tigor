					...
					<SplideSlide>
						...
						<div class="splide__slide-desc">
							...
							<ul>
								...
								<li><b>Яндекс Смена:</b> Организация и поддержка системы, которая повышает эффективность бизнеса.</li>
							</ul>

							<p>Проекты для лидеров ритейла:</p>
							<ul>
								<li><b>Drivee:</b> Внедрение эффективных решений для поставок.</li>
