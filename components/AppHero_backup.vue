							...
							<div class="splide__slide-inner">
								<div class="splide__slide-block-1">
									...
									<div class="splide__slide-desc">
										<p>Компания оказывает услуги по аутсорсингу курьеров в Москве и Московской области. Наши курьеры оперативно доставят негабаритные грузы, продукцию или документы.</p>
									</div>
...
.hero__inner::before {
	...
	background-color: var(--hero-inner-shadow-1);
}
...
.splide__slide-desc ul {
	padding-left: 20px;
}

.splide__slide-desc li {
	position: relative;
	padding-left: 18px;
}

.splide__slide-desc li::before {
	content: "";
	position: absolute;
	top: 12px;
	left: 0;
